...
This project is a physics simulation developed with **C++ and
OpenGL**.\
...
git clone https://github.com/DannyLopezC/PhysicsSimulation.git\
...
_(More controls may be added as UI features grow.)_
